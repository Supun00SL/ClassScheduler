...
export class PopoverPage implements OnInit {
    ...
    popoverdata: { details: { title: string, code: string, time: string, lecturer: string, location, string, lecturehall: string }[] }[];
    ...
    setPopOver(): void {
        ...
        this.http.post("http://138.197.37.12:8080/ClassAppServerSide/popover", JSON.stringify(this.data), headers).subscribe(
            data => {
